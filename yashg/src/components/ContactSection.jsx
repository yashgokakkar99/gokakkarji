        ...
        <div>
          <form className="flex flex-col p-3">
            <input
              ...
              className="bg-transparent p-3 outline-none border focus:border-white focus:border-2 focus:pl-8 transition-all duration-100 rounded-lg border-white gradient-text font-mon text-lg lg:text-2xl  mb-5 lg:mb-10 w-full lg:w-[30vw]"
            />
            <input
              type="email"
              name="email"
